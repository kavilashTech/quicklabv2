...
//        return ;
    ...
    public function getStates(Request $request) {
        ...
        foreach ($states as $state) {
            ...
            if(!empty(Auth::user()->state) && Auth::user()->state == $state->id && $request->type != 2){
    ...
    public function getCities(Request $request) {
        ...
        foreach ($cities as $row) {
            ...
            if(!empty(Auth::user()->city) && Auth::user()->city == $row->id && $request->type != 2){

                $html .= '<option value="' . $row->id . '" selected="selected">' . $row->getTranslation('name') . '</option>';
            }else{
