...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        $product = $this->productService->store($request->except([
            '_token', 'sku', 'width','breadth','height','usd_price','usd_points','wholesale_price','dispatch_days', 'choice', 'tax_id', 'tax', 'tax_type', 'flash_deal_id', 'flash_discount', 'flash_discount_type'
        ]));
        ...
        $this->productStockService->store($request->only([
            'colors_active', 'colors', 'choice_no', 'unit_price', 'sku','width','breadth','height','usd_price','usd_points','wholesale_price','dispatch_days', 'hsn_code','expiry_month','expiry_year','batch_number', 'current_stock', 'product_id'
        ]), $product);
    ...
    public function update(ProductRequest $request, Product $product)
    {
        ...
        $request->merge(['product_id' => $product->id]);
        $this->productStockService->store($request->only([
            'colors_active', 'colors', 'choice_no', 'unit_price', 'sku','width','breadth','height','usd_price','usd_points','wholesale_price','dispatch_days','expiry_month','expiry_year','batch_number', 'hsn_code', 'current_stock', 'product_id'
        ]), $product);
