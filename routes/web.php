...
Route::controller(HomeController::class)->group(function () {
	...
	// Route::get('franchiseedocumentupload','franchiseedocumentupload')->name('franchiseedocumentupload');
	// Route::post('franchisee-document-upload','franchisee_document_upload')->name('franchisee-document-upload');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function () {
	...
	Route::controller(HomeController::class)->group(function () {
		...
		Route::post('/user/update-contact-address', 'updateUserContactAddress')->name('user.address.update');
		Route::get('/user/edit-contact-address', 'editUserContactAddress')->name('user.address.edit');
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function () {
	...
	Route::group(['prefix' => 'checkout'], function () {
		Route::controller(CheckoutController::class)->group(function () {
			...
			Route::any('/payment_select', 'store_delivery_info')->name('checkout.store_delivery_info');
...
Route::controller(PageController::class)->group(function () {
	...
	Route::post('/contact-us', 'postContactUs')->name('post.contactus');
	//Custom page
...
Route::controller(GenerateQuoteController::class)->group(function () {
	...
	Route::get('quote/savedview', 'savedview')->name('quote-savedview');
...
Route::get('/re-order/{id}', [PurchaseHistoryController::class, 'reOrder'])->name('reorder-product');
