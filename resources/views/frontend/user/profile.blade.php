                ...
                <div class="col-lg-6">
                    <div class="border p-3 pr-5 rounded mb-3 position-relative">
                        ...
                        <div>
                            ...
                            <span class="ml-2">{{ Auth::user()->postal_code }}</span>
                        </div>
                        <div>
                            <span class="w-50 fw-600">{{ translate('City') }}:</span>
                            <span class="ml-2">{{ $addressDetails['city_name'] }}</span>
                        </div>
                        <div>
                            <span class="w-50 fw-600">{{ translate('State') }}:</span>
                            <span class="ml-2">{{ $addressDetails['state_name'] }}</span>
                        </div>
                        <div>
                            <span class="w-50 fw-600">{{ translate('Country') }}:</span>
                            <span class="ml-2">{{ $addressDetails['country_name'] }}</span>
                        </div>
                        <div>
                        ...
                        <div class="dropdown position-absolute right-0 top-0">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" onclick="edit_user_contact_address('{{ Auth::user()->id }}' )">
                                    {{ translate('Edit') }}
                                </a>
                            </div>
                        </div>
