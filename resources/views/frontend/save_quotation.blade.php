            ...
            <div class="row">
                <div class="col-xxl-12 col-xl-12 mx-auto">
                    <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-left">
                        <div class="tabs">
                            <span style="background: #1c9126;opacity: .4;" ><a href="{{ route('quote-view')}}"><button class=" btn-primary" style="background: #1c9126;border: aliceblue;">{{ translate('Quotation') }}</button></a> </span>
                             <span ><a href="{{ route('quote-savedview')}}"><button class=" btn-primary" style="background: #1c9126;border: aliceblue;">{{ translate('Saved Quotation') }}</button></a> </span>
            ...
            <div class="card-body">
                <table class="table aiz-table mb-0">
                    ...
                    <tbody>
                        ...
                        @endphp
                            <tr>
                                <td>{{ ($savequotations->currentPage() - 1) * $savequotations->perPage() + $loop->iteration }}</td>
