                ...
                @else
                    ...
                    @if(Auth::user()->user_type == 'customer')
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <a href="{{ route('quote-view') }}" class="aiz-side-nav-link {{ areActiveRoutes(['quotation.list','quote-view'])}}">
                                <i class="las la-file-alt aiz-side-nav-icon"></i>
                    ...
                    @endif
                        ...
                        <li class="aiz-side-nav-item">
                         ...
                         <li class="aiz-side-nav-item">
                            <a href="{{ route('customer_list.franchisee_sales_report') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customer_list.franchisee_sales_report'])}}">
                                <i class="la la-user-o aiz-side-nav-icon"></i>
