            ...
            <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
                ...
                @else
                    ...
                    @if (Auth::user()->user_type == 'partner')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('purchase_history_franchise.index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['purchase_history_franchise.index', 'purchase_history.details']) }}">
                    ...
                    @if (Auth::user()->user_type == 'customer')
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <a href="{{ route('quote-view') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['quotation.list', 'quote-view']) }}">
                                <i class="las la-file-alt aiz-side-nav-icon"></i>
                    ...
                    @if (Auth::user()->user_type == 'partner')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customer_list.franciesindex') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['customer_list.franciesindex']) }}">
                                <i class="la la-user-o aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">{{ translate('Customers') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customer.franciesindex') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['customer.franciesindex']) }}">
                                <i class="la la-user-o aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">{{ translate('Add Customer') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customer_list.franchisee_sales_report') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['customer_list.franchisee_sales_report']) }}">
                                <i class="la la-user-o aiz-side-nav-icon"></i>
