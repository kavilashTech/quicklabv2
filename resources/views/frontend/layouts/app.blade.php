...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('assets/css/custom-style.css') }}">
...
<body>
    ...
    <script src="{{ secure_asset('assets/js/aiz-core.js') }}"></script>
    ...
    <script>
        ...
        function generateQuote(id){
            ...
            @else
                AIZ.plugins.notify('warning', "{{ translate('Please login to view Quotations') }}");
            @endif
            ...
            if($('#option-choice-form input[name=quantity]').val() > 0 && checkAddToCartValidity()){
                $.ajax({
                   ...
                   success: function(data){
                        ...
                        $('#option-choice-form #chosen_whole_price_div').removeClass('d-none');
                        $('#option-choice-form #chosen_whole_price_div #wholesale_price').html(data.wholesalePrice);
        ...
        function buyNow(){
            ...
            function(data){ if(data==1){ $('#addToCart-modal-body').html(data.modal_view);
