  ...
  <body>
    <div class="container">
      ...
      <div style="padding: 0px 30px 15px; position: relative; z-index: 99">
        ...
        >
          <img
            src="https://store.suitecrm.com/assets/img/addons/bv-email-verify/logo.png?1644951288"
            alt="email"
            style="width: 100%"
          />
        </div>
        ...
        <p>
          Dear <span style="color: #243824; font-weight: bold">{{ $array['name'] }}</span>,
        </p>
        <p style="margin-top: 0px">
          You have requested for resetting your password. Kindly copy the code below and use it to reset your password in Quicklab.
...
<!--
        <p style="font-size: 13px; margin-bottom: 0px">
          ...
          <a href="#" style="color: #243824; font-weight: 600; font-size: 15px">
            Resend Confirmation Mail.</a
          >
        </p>
		-->
      </div>
