                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" placeholder="{{ translate('HSN Code') }}"
                                        value="{{ optional($product->stocks->first())->hsn_code }}" name="hsn_code"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div id="show-hide-div">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 d-flex">
                                        <input class="form-control" type="number" name="width"
                                            value="{{ optional($product->stocks->first())->width }}" placeholder="width"
                                            min="0" maxlength="3"
                                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        <input class="form-control" type="number" name="breadth"
                                            value="{{ optional($product->stocks->first())->breadth }}"
                                            placeholder="breadth" min="0" maxlength="3"
                                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        <input class="form-control" type="number" name="height"
                                            value="{{ optional($product->stocks->first())->height }}"
                                            placeholder="height" min="0" maxlength="3"
                                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" placeholder="{{ translate('USD Price') }}"
                                            value="{{ optional($product->stocks->first())->usd_price }}" name="usd_price"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" placeholder="{{ translate('USD Points') }}"
                                            value="{{ optional($product->stocks->first())->usd_points }}"
                                            name="usd_points" class="form-control" min="0" maxlength="3"
                                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" placeholder="{{ translate('Franchisee price') }}"
                                            id="wholesale_price"
                                            value="{{ optional($product->stocks->first())->wholesale_price }}"
                                            name="wholesale_price" class="form-control wholesale_price" step='0.01'>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" placeholder="{{ translate('Dispatch Days') }}"
                                            value="{{ optional($product->stocks->first())->dispatch_days }}"
                                            name="dispatch_days" class="form-control" min="0" maxlength="3"
                                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <select class="form-control aiz-selectpicker" name="expiry_month"
                                            id="expiry_month" data-live-search="true">
                                            <option value="">Select Expiry Month</option>
                                            @foreach (json_decode(get_setting('expiry_month_array'), true) as $key => $value)
                                                <option value="{{ $value }}" <?php if (!empty($product->stocks[0]->expiry_month) && $product->stocks[0]->expiry_month == $value) {
                                                    echo 'selected';
                                                } ?>>
                                                    {{ $value }}</option>
                                            @endforeach
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <select class="form-control aiz-selectpicker" name="expiry_year" id="expiry_year"
                                            data-live-search="true">
                                            <option value="">Select Expiry Year</option>
                                            @foreach (json_decode(get_setting('expiry_year_array'), true) as $key => $value)
                                                <option value="{{ $value }}" <?php if (!empty($product->stocks[0]->expiry_year) && $product->stocks[0]->expiry_year == $value) {
                                                    echo 'selected';
                                                } ?>>
                                                    {{ $value }}</option>
                                            @endforeach
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" placeholder="{{ translate('Batch Number') }}"
                                            value="{{ optional($product->stocks->first())->batch_number }}"
                                            name="batch_number" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="card-body collapse show" id="collapse_2">
                                @if (get_setting('shipping_type') == 'product_wise_shipping')
                                    ...
                                    <div class="flat_rate_shipping_div" style="display: none">
                                        <div class="form-group row">
                                            <label
                                                class="col-lg-6 col-from-label">{{ translate('Shipping cost') }}</label>
                                            <div class="col-lg-6">
                                                <input type="number" lang="en" min="0"
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <label class="aiz-switch aiz-switch-success mb-0">
                                                    <input type="checkbox" name="returnable" value="1"
                                                        @if ($product->returnable == 1) checked @endif>
                                                    <span></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label
                                                class="col-md-6 col-from-label">{{ translate('Number of days') }}</label>
                                            <div class="col-md-6">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $(document).on('change', '.wholesale_price1', function() {
                var id = $(this).attr('id');
                document.getElementById(id).value = parseFloat($(this).val()).toFixed(2);
            });
        });
        ...
        function update_sku() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.length == '0') {
                        $("#choice_attributes").find("option:selected").prop('selected', false);
                        //$("#choice_attributes").text('Nothing selected');
                        //$('#choice_attributes').html('');
                    }
                    if (data.length > 1) {
                        $('#show-hide-div').hide();
                    } else {
