                    ...
                    <div class="card-body">
                        ...
                        <div id="show-hide-div">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" placeholder="{{ translate('Franchisee price') }}" id="wholesale_price" value="{{ optional($product->stocks->first())->wholesale_price }}" name="wholesale_price" class="form-control wholesale_price"  step='0.01'  >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">
