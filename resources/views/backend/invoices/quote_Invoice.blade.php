...
<body>
        ...
        <table align="center" border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
          ...
          <tr>
            <td style="padding: 3px 8px;vertical-align: top;border-top: 1px solid;width: 50%;">
              <b style="text-transform: uppercase;padding: 5px 0;display: block;">{{$quotationOtherDetails['company_name']}}</b>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
                ...
                <p style="margin: 0;padding: 2px 0;">Details of the product can be sees in the Product Catalogue</p>
                <p style="margin: 0;padding: 2px 0;">  </p>
                <p style="margin: 0;padding: 2px 0;">  </p>
              </td>
              <td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
                @if ($cartItem['digital'] != 1 && $product->auction_product == 0)
                  <p style="margin: 0;padding: 2px 0;text-align: right;"> {{ $cartItem['quantity'] }}</p>
              ...
              @if(!empty($quotationOtherDetails['taxAvailable']) && $quotationOtherDetails['taxAvailable'] == 1)
                <td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
                  <p style="margin: 0;padding: 2px 0;text-align: right;"> {{ $cartItem->tax1 }}%</p>
                </td>
                <td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
                  <p style="margin: 0;padding: 2px 0;text-align: right;"> {{ single_price($cartItem->tax2_amount) }}</p>
                </td>
                <td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
                  <p style="margin: 0;padding: 2px 0;text-align: right;"> {{ $cartItem->tax2 }}%</p>
                </td>
                <td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
                  <p style="margin: 0;padding: 2px 0;text-align: right;"> {{ single_price($cartItem->tax2_amount) }}</p>
                </td>
        ...
        <table align="center" border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
          <tr>
            <td style="padding: 8px;vertical-align: top;width: 60%;">
              ...
              <p  style="margin: 0;padding: 2px 0;"> 1. Payment Should Be Made In favour of "Quicklab Services" by NEFT/RTGS/WIRE TRANSFER </p>
              <p  style="margin: 0;padding: 2px 0;">  2.Payment 100% advance. </p>
			  <p  style="margin: 0;padding: 2px 0;">  3.Bank Transfer Charges & Custom Clearances by Buyer. </p>
  ...
  <p style="font-size: 12px;font-weight: 400;margin: 0;padding: 4px 0; text-align: center;font-family: Arial, Helvetica, sans-serif;">
