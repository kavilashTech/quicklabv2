        ...
        <table align="center" border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
          <tr>
            <td style="width:300px">
              <img src="{{ static_asset('assets/img/logo_invoice.png') }}" width="250" style="display:inline-block;" alt="invoice logo">
            </td>
            <td>
              ...
              <p style="margin: 0;padding: 1px 0;">
                Email : <a href="mailto:{{ get_setting('contact_email') }}"
                  style="color: #000;text-decoration: none;">{{ get_setting('contact_email') }}</a>, <a href="mailto:{{ get_setting('service_email') }}"
          ...
          <tbody>
            ...
            @foreach ($order->orderDetails as $key => $orderDetail)
              <tr>
                ...
                <td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
                  <p style="margin: 0;padding: 2px 0;text-align: right;"> {{ single_price(($orderDetail->product->unit_price - $orderDetail->product->discount)) }}</p>
                </td>
                @if(!empty($orderOtherDetails['taxAvailable']) && $orderOtherDetails['taxAvailable'] == 1)
                  <td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
                  ...
                  <td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
                    <p style="margin: 0;padding: 2px 0;text-align: right;"> {{ single_price(($orderDetail->product->unit_price - $orderDetail->product->discount) * $orderDetail->quantity) }} </p>
                  </td>
                @elseif(!empty($orderOtherDetails['taxAvailable']) && $orderOtherDetails['taxAvailable'] == 2)
                  <td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
