...
<body>
	...
	<table align="center" border="0" cellspacing="0" cellpadding="0" style="width: 1000px;border: 1px solid #000;font-family: Arial, Helvetica, sans-serif;font-size: 14px;vertical-align: top;">
		<tr>
				...
				<table align="center" border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
					<tr>
						...
						<td>
							...
							<p style="margin: 0;padding: 1px 0;">
								Email : <a href="mailto:{{ get_setting('contact_email') }}" style="color: #000;text-decoration: none;">{{ get_setting('contact_email') }}</a>, <a href="mailto:{{ get_setting('service_email') }}" style="color: #000;text-decoration: none;">{{ get_setting('service_email') }}</a>,
							</p>
							<p style="margin: 0;padding: 1px 0;">
								Website: <a href="{{ get_setting('website_url') }}" style="color: #000;text-decoration: none;">{{ get_setting('website_url') }}</a>
							</p>
						</td>
			...
			<td style="border-top:1px solid #000;">
                ...
                <tr>
                  ...
                  <td>
						...
						<td style="padding: 8px;vertical-align: top;border-left: 1px solid;width: 50%;">
							<table align="center" border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
								<tr>
									...
									<td>
										<b>: {{ $shipping_address->state }} ({{ $orderOtherDetails['state_id']}})</b>
									</td>
									@else
									<td>
					...
					<tr>
						<td style="padding: 3px 8px;vertical-align: top;border-top: 1px solid;background: #f2f3f4;width: 50%;">
							<b>Bill To</b>
						</td>
						<td style="padding: 3px 8px;vertical-align: top;border-left: 1px solid;background: #f2f3f4;border-top: 1px solid;width: 50%;border-right: 1px solid;">
							<b>Ship To</b>
						</td>
					</tr>
					<tr>
						<td style="padding: 3px 8px;vertical-align: top;border-top: 1px solid;width: 50%;">
							<b style="text-transform: uppercase;padding: 5px 0;display: block;">{{ $shipping_address->name }}</b>
						...
						<td style="padding: 3px 8px;vertical-align: top;border-left: 1px solid;border-top: 1px solid;width: 50%;">
							<p style="margin: 0;padding: 2px 0;">
								{{ $shipping_address->address }},
							</p>
							<p style="margin: 0;padding: 2px 0;">
		...
		<tr>
			<td style="border-top: 1px solid;">
				<table align="center" border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
					<thead>
						<tr>
							<th rowspan="2" style="vertical-align: bottom; padding: 4px 8px;border-bottom: 1px solid;background: #f2f3f4;">
								#
							</th>
							<th rowspan="2" style="vertical-align: bottom; padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; background: #f2f3f4;text-align: left;width: 200px;">
								Item & Description</th>
							<th rowspan="2" style="vertical-align: bottom; padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; background: #f2f3f4;text-align: right;">
								Qty</th>
							<th rowspan="2" style="vertical-align: bottom; padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; background: #f2f3f4;text-align: right;">
								Rate</th>
							@if(!empty($orderOtherDetails['taxAvailable']) && $orderOtherDetails['taxAvailable'] == 1)
							<th colspan="2" style="vertical-align: bottom; padding: 4px 0px;border-bottom: 1px solid;border-left: 1px solid; background: #f2f3f4;">
								CGST
							</th>
							<th colspan="2" style="vertical-align: bottom; padding: 4px 0px;border-bottom: 1px solid;border-left: 1px solid; background: #f2f3f4;">
								SGST
						...
						@if(!empty($orderOtherDetails['taxAvailable']) && $orderOtherDetails['taxAvailable'] == 1)
						<tr>
							<th style="padding: 4px 8px;text-align: right; border-bottom: 1px solid;border-left: 1px solid; background: #f2f3f4;">
								%</th>
							<th style="padding: 4px 8px;text-align: right; border-bottom: 1px solid;border-left: 1px solid; background: #f2f3f4;">
								Amt</th>
							<th style="padding: 4px 8px;text-align: right; border-bottom: 1px solid;border-left: 1px solid; background: #f2f3f4;">
								%</th>
							<th style="padding: 4px 8px;text-align: right; border-bottom: 1px solid;border-left: 1px solid; background: #f2f3f4;border-right: 1px solid;">
								Amt</th>
						</tr>
						@elseif(!empty($orderOtherDetails['taxAvailable']) && $orderOtherDetails['taxAvailable'] == 2)
						<tr>
					...
					<tbody>
						...
						<tr>
							...
							<td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
								...
								<p style="margin: 0;padding: 2px 0;"> {{translate('Batch')}}: {{ $product_stock['batch_number'] }} </p>
								<p style="margin: 0;padding: 2px 0;">{{translate('Expiry')}}: {{ $product_stock['expiry_month'] }}-{{ $product_stock['expiry_year'] }} </p>
								<p style="margin: 0;padding: 2px 0;">{{translate('HSN')}}: {{ $product_stock['hsn_code'] }} </p>
							</td>
							<td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
								<p style="margin: 0;padding: 2px 0;text-align: right;"> {{ $orderDetail->quantity }}</p>
								<p style="margin: 0;padding: 2px 0;text-align: right;"> {{ strtoupper($orderDetail->product->unit) }} </p>
							</td>
							<td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
								<p style="margin: 0;padding: 2px 0;text-align: right;"> {{ single_price($orderDetail->price) }}</p>
							</td>
							@if(!empty($orderOtherDetails['taxAvailable']) && $orderOtherDetails['taxAvailable'] == 1)
							<td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
								<p style="margin: 0;padding: 2px 0;text-align: right;"> {{$taxDetails['cgst']}}%</p>
							</td>
							<td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
								<p style="margin: 0;padding: 2px 0;text-align: right;"> {{ single_price($taxDetails['cgstAmt']) }}</p>
							</td>
							<td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
								<p style="margin: 0;padding: 2px 0;text-align: right;"> {{$taxDetails['sgst']}}%</p>
							</td>
							<td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
								<p style="margin: 0;padding: 2px 0;text-align: right;"> {{ single_price($taxDetails['sgstAmt']) }}</p>
							</td>
							<td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
								<p style="margin: 0;padding: 2px 0;text-align: right;"> {{ single_price($orderDetail->price * $orderDetail->quantity) }} </p>
							</td>
							@elseif(!empty($orderOtherDetails['taxAvailable']) && $orderOtherDetails['taxAvailable'] == 2)
							<td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
								<p style="margin: 0;padding: 2px 0;text-align: right;"> {{$taxDetails['igst']}}%</p>
							</td>
							<td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
								<p style="margin: 0;padding: 2px 0;text-align: right;"> {{ single_price($taxDetails['igstAmt']) }}</p>
							</td>
							<td style="padding: 4px 8px;border-bottom: 1px solid;border-left: 1px solid; ">
								<p style="margin: 0;padding: 2px 0;text-align: right;"> {{ single_price($orderDetail->price * $orderDetail->quantity) }} </p>
							</td>
		...
		<tr>
			...
			<td style="padding-bottom: 100px;">
				<table align="center" border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
					<tr>
						<td style="padding: 8px;vertical-align: top;width: 60%;">
							<p style="margin: 0;padding: 2px 0;">Items in Total {{ $taxTotalDetails['itemsTotalQty'] }}</p>
              ...
              <p  style="margin: 0;padding: 2px 0;"> Swift Code : {{($bankAccountDetails != '') ?  $bankAccountDetails['swift_code'] : ''}} </p> -->
							...
							<p style="margin: 0;padding: 2px 0;"> 1. Payment Should Be Made In favour of "Quicklab Services" </p>
							...
							<p style="margin: 0;padding: 2px 0;"> 4.Warranty available for the products as mentioned in the product details. </p>
							<p style="margin: 0;padding: 2px 0;"> 5.Delivery period may vary according to the holidays. </p>
						</td>

						<td style="padding: 8px;vertical-align: top;width: 40%;padding: 0;">
							<table align="center" border="0" cellspacing="0" cellpadding="0" style="width: 100%;text-align: right;border-left: 1px solid;border-bottom: 1px solid;">
								<tr>
	...
	<p style="font-size: 12px;font-weight: 500;margin: 0;padding: 4px 0; text-align: center;font-family: Arial, Helvetica, sans-serif;">
