            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{translate('Quotation Validity Days')}}</label>
                            <div class="col-sm-9">
                                <input type="hidden" name="types[]" value="quotation_expire">
                                <input type="text" name="quotation_expire" class="form-control" value="{{ get_setting('quotation_expire') }}">
                            </div>
                        </div>
